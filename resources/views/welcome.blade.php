<x-guest-layout>
    ...
    <section class="sm:py-16">
        <div class="px-4 max-w-8xl sm:px-6 lg:px-8 relative min-h-screen" style="background-image: url('{{ asset('images/beaground2.jpg') }}'); background-size: cover; background-position: center;">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <h2 class="w-full text-center font-sans py-3 text-4xl font-black leading-10 tracking-wide text-white sm:text-6xl lg:text-7xl">
                    Selamat Datang Di
                    <span class="block font-mono lg:mt-3">Website UMKM</span>
                    <span class="block h-24 font-black font-sans text-blue-500 lg:mt-3">Desa Cimulang</span>
                </h2>
                <p class="my-4 text-lg text-center text-gray-300">
                    Website ini adalah sebuah platform digital yang bertujuan untuk mendukung dan memperkuat Usaha Mikro, Kecil, dan Menengah UMKM yang berlokasi di Desa Cimulang.
                </p>
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('umkm.index') }}" class="px-8 py-4 mb-2 mr-2 text-base font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-400">
                        Info UMKM
                    </a>
                    <a href="https://wa.me/087788132326/" class="px-8 py-4 mb-2 mr-2 text-base font-medium text-center text-white rounded-lg bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-800">
                        Butuh Bantuan
                    </a>
                </div>
            </div>
        ...
        <div id="documentasi">
            <h1 class="text-3xl lg:text-5xl font-bold text-center mb-8 mt-8 text-blue-500">Documentasi UMKM Desa Cimulang</h1>
            <div x-data="{ openImage: null }" class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-12 sm:mt-20">
                <!-- Thumbnails -->
                <div @click="openImage = 'image1.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image1.jpg') }}" alt="">
                </div>
                <div @click="openImage = 'image2.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image2.jpg') }}" alt="">
                </div>
                <div @click="openImage = 'image3.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image3.jpg') }}" alt="">
                </div>
                <div @click="openImage = 'image4.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image4.jpg') }}" alt="">
                </div>
                <div @click="openImage = 'image5.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image5.jpg') }}" alt="">
                </div>
                <div @click="openImage = 'image6.jpg'" class="cursor-pointer transition-transform transform hover:scale-105">
                    <img class="w-full h-48 object-cover rounded-lg shadow-md" src="{{ asset('images/image6.jpg') }}" alt="">
                </div>
            
                <!-- Individual Image Modal -->
                <div x-show="openImage" @click.away="openImage = null" class="fixed inset-0 z-50 overflow-hidden bg-black bg-opacity-80 flex items-center justify-center transition-opacity duration-300">
                    <div class="max-w-md mx-auto relative opacity-100 transition-opacity"> <!-- Adjust max-width as per your preference -->
                        <img class="w-full h-full object-contain" :src="`${('images')}/${openImage}`" alt="">
                        <!-- Close Button -->
                        <button @click="openImage = null" class="absolute top-0 right-0 m-4 text-white hover:text-gray-300 focus:outline-none">
    ...
    <section id="tentangkami" class="py-10 bg-gray-100 md:py-16 lg:py-24">
        <div class="container px-4 mx-auto md:flex md:items-center md:space-x-8">
            ...
            <div class="md:w-1/2">
                ...
                <p class="w-full text-center text-gray-600 md:text-2xl"> Selamat datang di halaman kami yang
                    didedikasikan
            ...
            <div class="mt-8 md:w-1/2 md:mt-0">
                <div class="aspect-w-16 aspect-h-9 border border-blue-500 border-spacing-2 ">
                    <iframe class="w-full shadow-sm " height="315"
                        src="https://www.youtube.com/embed/NhsPaLbkpes?si=-Br0D-Kk3cRjlM-B" title="YouTube video player"
                        frameborder="0"
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                @foreach ($umkms as $umkm)
                    <a href="{{ route('umkm.show', $umkm->id) }}"
                        ...
                        <img class="object-cover w-screen h-56 mt-4 rounded-t-lg" src="{{ $umkm->thumbnail }}"
                            alt="UMKM Image">
                        ...
                        <div class="p-4">
                            ...
                            <button class="  text-white  rounded-lg flex items-center mx-auto mt-2 p-2 bg-teal-500">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-auto h-7  me-2"
    ...
    <section id="hubungikami" class=" container h-auto mx-auto bg-gray-100 ">
        <h1 class="p-5 mt-10 mb-4 text-5xl font-extrabold text-center ">
            Hubungi Kami
        </h1>
                ...
                <form>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="message" rows="3"
                            class="block w-full px-3 py-2 transition duration-200 border rounded border-neutral-300 focus:outline-none focus:ring-blue focus:border-blue "></textarea>
                    </div>
