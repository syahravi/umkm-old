    ...
    <section class="sm:py-16 lg:py-24">
        <div class="px-4 max-w-8xl sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="w-full py-4 text-4xl font-bold leading-10 tracking-wide text-black sm:text-6xl lg:text-7xl"> Selamat Datang di <span class="block lg:mt-3">Website UMKM</span>
                    <span class="block h-24 text-transparent lg:mt-3 bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">Desa Cimulang</span>
                </h2>
                <p class="my-4 text-lg text-gray-600 mb-7">Website ini adalah sebuah platform digital yang bertujuan untuk mendukung dan memperkuat Usaha Mikro, Kecil, dan Menengah UMKM yang berlokasi di Desa Cimulang. </p>
                <div class="flex justify-center space-x-4">
                    <a href="/info_umkm" class="px-8 py-4 mb-2 mr-2 text-base font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-400"> Info UMKM </a>
                    <a href="https://api.whatsapp.com/qr/6KCVZL7AK5K5L1?autoload=1&app_absent=0" class="px-8 py-4 mb-2 mr-2 text-base font-medium text-center text-white rounded-lg bg-slate-950 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-800"> Butuh Bantuan </a>
                </div>
            </div>
    ...
    <section class="py-10 bg-gray-100 md:py-16 lg:py-24">
        <div class="container px-4 mx-auto md:flex md:items-center md:space-x-8">
            ...
            <div class="md:w-1/2">
                ...
                <h2 class="mb-4 text-3xl font-bold text-center md:text-5xl "> Tentang UMKM di <span class="mt-1 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400"> Desa Cimulang </span>
                </h2>
                <p class="w-full text-left text-gray-600 md:text-2xl"> Selamat datang di halaman kami yang didedikasikan untuk Usaha Mikro, Kecil, dan Menengah UMKM di Desa Cimulang. Kami berkomitmen untuk mendukung pertumbuhan dan perkembangan UMKM lokal agar dapat berkembang dan berkontribusi dalam memajukan perekonomian di wilayah ini. </p>
            </div>
        ...
        <div class="container mx-auto">
            <h1
                ...
                <a href="/info_umkm"
                    ...
                    Lihat Selengkapnya
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 ml-1 -mr-1" viewBox="0 0 20 20" fill="currentColor">
