        ...
        <section class="py-10 sm:py-16 lg:py-24">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                    <div>
                        <h1 class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400 sm:text-6xl lg:text-7xl">
                        {{ $umkm->name }}
                            <div class="relative inline-flex">
                            </div>
                        </h1>
    
                        <p class="mt-8 text-base text-black sm:text-xl">{{ $umkm->description }} </p>
                    ...
                    <div>
                        <img class="w-full h-auto rounded-lg object-cover shadow"
                        src="{{ $umkm->thumbnail }}" alt="{{ $umkm->name }}" alt="umkm" >
                    </div>
                </div>
            </div>
        </section>
                ...
                @foreach ($products as $product)
                    <div class="overflow-hidden bg-white rounded shadow">
                        <div class="p-5">
                            ...
                            <p class=" w-auto h-16 overflow-y-auto mt-4 text-base text-gray-600">{{ $product->description }}</p>
